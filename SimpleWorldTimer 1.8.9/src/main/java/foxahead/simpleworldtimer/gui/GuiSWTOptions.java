...
public class GuiSWTOptions extends GuiScreen implements ISWTSliderObserver {
  ...
  public void initGui() {
    ...
    this.startDateTextField = new GuiTextField(1, this.fontRendererObj, xCoord + 150, yCoord + yStep * 5, 50, 20);
    this.patternTextField1  = new GuiTextField(2, this.fontRendererObj, xCoord, yCoord + yStep * 6, 176, 20);
    this.patternTextField2  = new GuiTextField(3, this.fontRendererObj, xCoord, yCoord + yStep * 7, 176, 20);
  ...
  public void drawScreen(int par1, int par2, float par3) {
    ...
    this.drawCenteredString(this.fontRendererObj, I18n.format("options.swt.title"), this.width / 2, yCoord, COLOR1);
