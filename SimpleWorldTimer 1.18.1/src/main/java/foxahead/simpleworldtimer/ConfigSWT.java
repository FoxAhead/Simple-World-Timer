...
public class ConfigSWT {
  ...
  public static List<Component> getPresetList() {
    return Arrays.asList(new TranslatableComponent("options.swt.preset0"),
                         new TranslatableComponent("options.swt.preset1"),
                         new TranslatableComponent("options.swt.preset2"),
                         new TranslatableComponent("options.swt.preset3"),
                         new TranslatableComponent("options.swt.preset4"));
  }

  public static List<Component> getClockTypeList() {
    return Arrays.asList(new TranslatableComponent("options.swt.clockType0"),
                         new TranslatableComponent("options.swt.clockType1"),
                         new TranslatableComponent("options.swt.clockType2"),
                         new TranslatableComponent("options.swt.clockType3"));
  }
