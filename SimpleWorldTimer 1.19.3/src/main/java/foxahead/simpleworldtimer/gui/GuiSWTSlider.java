...
public class GuiSWTSlider extends AbstractWidget {
  ...
  protected void renderBg(PoseStack PoseStack, Minecraft p_renderBg_1_, int p_renderBg_2_, int p_renderBg_3_) {
    ...
    this.blit(PoseStack, getX( ) + (this.sliderValue * (this.width - 8) / 100), getY( ), 0, 46 + i, 4, 20);
    this.blit(PoseStack, getX( ) + (this.sliderValue * (this.width - 8) / 100) + 4, getY( ), 196, 46 + i, 4, 20);
  }
