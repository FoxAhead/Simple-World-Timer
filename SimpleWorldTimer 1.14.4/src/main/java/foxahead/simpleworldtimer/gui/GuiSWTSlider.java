...
public class GuiSWTSlider extends Widget {
  ...
  protected void renderBg(Minecraft p_renderBg_1_, int p_renderBg_2_, int p_renderBg_3_) {
    ...
    this.blit(this.x + (this.sliderValue * (this.width - 8) / 100), this.y, 0, 46 + i, 4, 20);
    this.blit(this.x + (this.sliderValue * (this.width - 8) / 100) + 4, this.y, 196, 46 + i, 4, 20);
  }
  ...
  private void setSliderDisplayString() {
    this.setMessage(this.sliderText + String.valueOf(this.sliderValue));
  }
