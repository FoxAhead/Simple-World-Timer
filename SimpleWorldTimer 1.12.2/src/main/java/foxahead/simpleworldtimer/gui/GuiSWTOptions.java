...
public class GuiSWTOptions extends GuiScreen implements ISWTSliderObserver {
  ...
  public void initGui() {
    ...
    this.startDateTextField = new GuiTextField(1, this.fontRenderer, xCoord + 150, yCoord + yStep * 5, 50, 20);
    this.patternTextField1  = new GuiTextField(2, this.fontRenderer, xCoord, yCoord + yStep * 6, 176, 20);
    this.patternTextField2  = new GuiTextField(3, this.fontRenderer, xCoord, yCoord + yStep * 7, 176, 20);
    this.buttonList.add(buttonSwap = new GuiButton(5, xCoord + 180, (int) (yCoord + yStep * 6.5F), 20, 20, ")"));
    this.buttonList.add(new GuiButton(0, xCoord, yCoord + yStep * 8, I18n.format("gui.done")));
    this.buttonList.add(buttonStart = new GuiButton(6, xCoord + 102, yCoord + yStep * 5, 30, 20, ">"));
    this.buttonList.add(buttonPause = new GuiButton(7, xCoord + 136, yCoord + yStep * 5, 30, 20, "||"));
    this.buttonList.add(buttonStop = new GuiButton(8, xCoord + 170, yCoord + yStep * 5, 30, 20, "[]"));
    updateButtons();
    initialized = true;
  }
  ...
  public void actionPerformed(GuiButton parGuiButton) {
    ...
    if (parGuiButton.id >= 6 || parGuiButton.id <= 8) {
      ...
      long now   = this.mc.world.getTotalWorldTime();
  ...
  protected void keyTyped(char par1, int par2) {
    ...
    if (par2 == KeyHandlerSWT.keySWT.getKeyCode() && !isTyping()) {
      this.closeMe();
    }
  }
  ...
  public void drawScreen(int par1, int par2, float par3) {
    ...
    this.drawCenteredString(this.fontRenderer, I18n.format("options.swt.title"), this.width / 2, yCoord, COLOR1);
