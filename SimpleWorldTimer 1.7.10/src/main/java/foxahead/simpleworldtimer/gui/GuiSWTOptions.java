...
public class GuiSWTOptions extends GuiScreen implements ISWTSliderObserver {
  ...
  public void initGui() {
    ...
    this.startDateTextField = new GuiTextField(this.fontRendererObj, xCoord + 150, yCoord + yStep * 5, 50, 20);
    this.patternTextField1  = new GuiTextField(this.fontRendererObj, xCoord, yCoord + yStep * 6, 176, 20);
    this.patternTextField2  = new GuiTextField(this.fontRendererObj, xCoord, yCoord + yStep * 7, 176, 20);
  ...
  protected void keyTyped(char par1, int par2) {
    ...
    if (par2 == KeyHandlerSWT.keySWT.getKeyCode()) {
      this.closeMe();
    }
  }
