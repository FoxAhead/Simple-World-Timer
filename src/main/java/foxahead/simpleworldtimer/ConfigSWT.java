...
public class ConfigSWT {
  ...
  public static List<String> getPresetList() {
    return Arrays.asList(I18n.getString("options.swt.preset0"),
                         I18n.getString("options.swt.preset1"),
                         I18n.getString("options.swt.preset2"),
                         I18n.getString("options.swt.preset3"),
                         I18n.getString("options.swt.preset4"));
  }

  public static List<String> getClockTypeList() {
    return Arrays.asList(I18n.getString("options.swt.clockType0"),
                         I18n.getString("options.swt.clockType1"),
                         I18n.getString("options.swt.clockType2"),
                         I18n.getString("options.swt.clockType3"));
  }
