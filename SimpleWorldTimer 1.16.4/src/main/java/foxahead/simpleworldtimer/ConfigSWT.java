...
public class ConfigSWT {
  ...
  public static List<ITextComponent> getPresetList() {
    return Arrays.asList(new TranslationTextComponent("options.swt.preset0"),
                         new TranslationTextComponent("options.swt.preset1"),
                         new TranslationTextComponent("options.swt.preset2"),
                         new TranslationTextComponent("options.swt.preset3"),
                         new TranslationTextComponent("options.swt.preset4"));
  }

  public static List<ITextComponent> getClockTypeList() {
    return Arrays.asList(new TranslationTextComponent("options.swt.clockType0"),
                         new TranslationTextComponent("options.swt.clockType1"),
                         new TranslationTextComponent("options.swt.clockType2"),
                         new TranslationTextComponent("options.swt.clockType3"));
  }
  ...
  public static void setxPosition(int xPosition) {
    ConfigSWTValues.xPosition.set(MathHelper.clamp(xPosition, 0, 100));
  }
  ...
  public static void setyPosition(int yPosition) {
    ConfigSWTValues.yPosition.set(MathHelper.clamp(yPosition, 0, 100));
  }
  ...
  public static void setPreset(int preset) {
    ConfigSWTValues.preset.set(MathHelper.clamp(preset, 0, getPresetList().size() - 1));
  }
  ...
  public static void setClockType(int clockType) {
    if (getPreset() == PRESET_CUSTOM) {
      ConfigSWTValues.clockType.set(MathHelper.clamp(clockType, 0, getClockTypeList().size() - 1));
    }
  }
